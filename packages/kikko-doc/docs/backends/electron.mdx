...
```bash
yarn add @kikko-land/react @kikko-land/query-builder @kikko-land/sql.js @kikko-land/electron-better-sqlite3-backend
```
...
```bash
npm i -S @kikko-land/react @kikko-land/query-builder @kikko-land/sql.js @kikko-land/electron-better-sqlite3-backend
```
