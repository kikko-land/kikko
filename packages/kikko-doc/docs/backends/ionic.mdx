...
```bash
yarn add @kikko-land/react @kikko-land/query-builder @kikko-land/sql.js @kikko-land/native-ionic-backend @kikko-land/absurd-web-backend cordova-sqlite-storage
```
...
```bash
npm i -S @kikko-land/react @kikko-land/query-builder @kikko-land/sql.js @kikko-land/native-ionic-backend @kikko-land/absurd-web-backend cordova-sqlite-storage
```
...
Code example: https://github.com/kikko-land/kikko-ionic-example
