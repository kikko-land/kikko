...
```bash
yarn add @trong-orm/react @trong-orm/query-builder @trong-orm/sql.js @trong-orm/electron-better-sqlite3-backend
```
...
```bash
npm i -S @trong-orm/react @trong-orm/query-builder @trong-orm/sql.js @trong-orm/electron-better-sqlite3-backend
```
