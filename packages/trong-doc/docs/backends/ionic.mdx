...
```bash
yarn add @trong-orm/react @trong-orm/query-builder @trong-orm/sql.js @trong-orm/native-ionic-backend @trong-orm/absurd-web-backend
```
...
```bash
npm i -S @trong-orm/react @trong-orm/query-builder @trong-orm/sql.js @trong-orm/native-ionic-backend @trong-orm/absurd-web-backend
```
