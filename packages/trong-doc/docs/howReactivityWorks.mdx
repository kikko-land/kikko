...
Trong ORM gather infomration about what table are sued when you build raw queries or with query-builder.
...
Then all queries that are subscribed to changed tables will be notified (see [Listen queries](/listen-queries)).
