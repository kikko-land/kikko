...
Trong ORM allows you to run reactive SQLite queries on any platforms with any framework/lib. For the web apps it uses [absurd-sql](https://github.com/jlongster/absurd-sql), for electron/react-native/ionic — native sqlite calls(WIP). It is actually framework/lib-agnostic, so you can integrate it to any framework/render libs you want.
...
With Tauri:
https://github.com/trong-orm/trong-tauri-example
